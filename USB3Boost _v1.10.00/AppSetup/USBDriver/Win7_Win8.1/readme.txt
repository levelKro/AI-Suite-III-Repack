...
5.  For XP, Vista, Server 2003, Server 2008, Win7
			Expand the 'Universal Serial Bus Controllers' entry

6.  Right-click on 'ASMedia XHCI Controller'
...
10. follow file shoud displayed, then installation was 
		...
		-'system32\DRIVERS\asmtxhci.sys' for XP, Vista, Server2003, Server 2008 and W7
...
Copyright (c) ASMedia Technology, 2011
************************************************************
